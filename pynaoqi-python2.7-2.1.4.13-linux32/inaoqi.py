...
def _ALSystem(pCommand):
    return _inaoqi._ALSystem(pCommand)
...
class baseModule(_object):
    ...
    def _methodMissing0(self, pModuleName, pMethod):
        return _inaoqi.baseModule__methodMissing0(self, pModuleName, pMethod)

    def _methodMissing1(self, pModuleName, pMethod, arg4):
        return _inaoqi.baseModule__methodMissing1(self, pModuleName, pMethod, arg4)

    def _methodMissing2(self, pModuleName, pMethod, arg4, arg5):
        return _inaoqi.baseModule__methodMissing2(self, pModuleName, pMethod, arg4, arg5)

    def _methodMissing3(self, pModuleName, pMethod, arg4, arg5, arg6):
        return _inaoqi.baseModule__methodMissing3(self, pModuleName, pMethod, arg4, arg5, arg6)

    def _methodMissing4(self, pModuleName, pMethod, arg4, arg5, arg6, arg7):
        return _inaoqi.baseModule__methodMissing4(self, pModuleName, pMethod, arg4, arg5, arg6, arg7)

    def _methodMissing5(self, pModuleName, pMethod, arg4, arg5, arg6, arg7, arg8):
        return _inaoqi.baseModule__methodMissing5(self, pModuleName, pMethod, arg4, arg5, arg6, arg7, arg8)

    def _methodMissing6(self, pModuleName, pMethod, arg4, arg5, arg6, arg7, arg8, arg9):
        return _inaoqi.baseModule__methodMissing6(self, pModuleName, pMethod, arg4, arg5, arg6, arg7, arg8, arg9)
...
class module(baseModule):
    ...
    def BIND_PYTHON(self, module, method, paramcount=-1):
        return _inaoqi.module_BIND_PYTHON(self, module, method, paramcount)

    def exit(self):
        return _inaoqi.module_exit(self)

    def getName(self):
        return _inaoqi.module_getName(self)

    def getBrokerName(self):
        return _inaoqi.module_getBrokerName(self)

    def _methodMissing(self):
        return _inaoqi.module__methodMissing(self)

    def version(self):
        return _inaoqi.module_version(self)

    def registerToBroker(self):
        return _inaoqi.module_registerToBroker(self)
...
class timeline(_object):
    ...
    def __init__(self, timeline):
        this = _inaoqi.new_timeline(timeline)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def play(self):
        return _inaoqi.timeline_play(self)

    def pause(self):
        return _inaoqi.timeline_pause(self)

    def stop(self):
        return _inaoqi.timeline_stop(self)

    def goTo(self, *args):
        return _inaoqi.timeline_goTo(self, *args)

    def getSize(self):
        return _inaoqi.timeline_getSize(self)

    def getFPS(self):
        return _inaoqi.timeline_getFPS(self)

    def setFPS(self, fps):
        return _inaoqi.timeline_setFPS(self, fps)
...
class behavior(baseModule):
    ...
    def __init__(self, name):
        this = _inaoqi.new_behavior(name)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def setEnabled(self, pEnabled):
        return _inaoqi.behavior_setEnabled(self, pEnabled)

    def isEnabled(self):
        return _inaoqi.behavior_isEnabled(self)

    def setResources(self, pList, pTimeout):
        return _inaoqi.behavior_setResources(self, pList, pTimeout)

    def waitFor(self, pList, pCallback, pTimeout, pOwnerType):
        return _inaoqi.behavior_waitFor(self, pList, pCallback, pTimeout, pOwnerType)

    def session(self):
        return _inaoqi.behavior_session(self)

    def acquireResources(self):
        return _inaoqi.behavior_acquireResources(self)

    def waitResourcesCallback(self, pCallback):
        return _inaoqi.behavior_waitResourcesCallback(self, pCallback)

    def isResourceFree(self, pList):
        return _inaoqi.behavior_isResourceFree(self, pList)

    def waitResourceFree(self):
        return _inaoqi.behavior_waitResourceFree(self)

    def waitResources(self):
        return _inaoqi.behavior_waitResources(self)

    def releaseResource(self):
        return _inaoqi.behavior_releaseResource(self)

    def addInput(self, pInputName):
        return _inaoqi.behavior_addInput(self, pInputName)

    def addOutput(self, pOutputName, pIsBang):
        return _inaoqi.behavior_addOutput(self, pOutputName, pIsBang)

    def addParameter(self, pParameterName, pValue, pInheritFromParent):
        return _inaoqi.behavior_addParameter(self, pParameterName, pValue, pInheritFromParent)

    def registerToBroker(self):
        return _inaoqi.behavior_registerToBroker(self)

    def getParameter(self, pParameterName):
        return _inaoqi.behavior_getParameter(self, pParameterName)

    def getParametersList(self):
        return _inaoqi.behavior_getParametersList(self)

    def setParameter(self, pParameterName, pValue):
        return _inaoqi.behavior_setParameter(self, pParameterName, pValue)

    def stimulateIO(self, pIOName, pValue):
        return _inaoqi.behavior_stimulateIO(self, pIOName, pValue)

    def BIND_PYTHON(self, module, method, paramcount=-1):
        return _inaoqi.behavior_BIND_PYTHON(self, module, method, paramcount)

    def setModuleDescription(self, description):
        return _inaoqi.behavior_setModuleDescription(self, description)

    def addParam(self, description):
        return _inaoqi.behavior_addParam(self, description)

    def exit(self):
        return _inaoqi.behavior_exit(self)

    def getName(self):
        return _inaoqi.behavior_getName(self)

    def setParentFromName(self, parentName):
        return _inaoqi.behavior_setParentFromName(self, parentName)

    def getBrokerName(self):
        return _inaoqi.behavior_getBrokerName(self)

    def _methodMissing(self):
        return _inaoqi.behavior__methodMissing(self)

    def version(self):
        return _inaoqi.behavior_version(self)

    def hasTimeline(self):
        return _inaoqi.behavior_hasTimeline(self)

    def getTimeline(self):
        return _inaoqi.behavior_getTimeline(self)

    def hasParentTimeline(self):
        return _inaoqi.behavior_hasParentTimeline(self)

    def getParentTimeline(self):
        return _inaoqi.behavior_getParentTimeline(self)

    def connectInput(self, pInputName, pALMemoryValueName, enabled):
        return _inaoqi.behavior_connectInput(self, pInputName, pALMemoryValueName, enabled)

    def connectParameter(self, pParameterName, pALMemoryValueName, enabled):
        return _inaoqi.behavior_connectParameter(self, pParameterName, pALMemoryValueName, enabled)

    def connectOutput(self, pOutputName, pALMemoryValueName, enabled):
        return _inaoqi.behavior_connectOutput(self, pOutputName, pALMemoryValueName, enabled)

    def _reportError(self, fmId, boxId, error):
        return _inaoqi.behavior__reportError(self, fmId, boxId, error)
